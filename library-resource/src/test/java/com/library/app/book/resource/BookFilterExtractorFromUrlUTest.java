...
public class BookFilterExtractorFromUrlUTest {
	...
	public void withPaginationAndNameAndUserTypeAndSortAscending() {
		setUpUriInfo("2", "5", "Software", "1", "id");
		...
		assertActualPaginationDataWithExpected(bookFilter.getPaginationData(), new PaginationData(10, 5, "id",
				OrderMode.ASCENDING));
		assertFieldsOnFilter(bookFilter, "Software", 1l);
	}

	@Test
	public void withPaginationAndNameAndSortAscendingWithPrefix() {
		setUpUriInfo("2", "5", "Software", null, "+id");
		...
		assertActualPaginationDataWithExpected(bookFilter.getPaginationData(), new PaginationData(10, 5, "id",
				OrderMode.ASCENDING));
		assertFieldsOnFilter(bookFilter, "Software", null);
	}
	...
	private void setUpUriInfo(final String page, final String perPage, final String title,
			final String categoryId, final String sort) {
